...
- Upgraded `@canva/app-ui-kit` to `5.13.0`.
- Upgraded preview version of `@canva/design` to `2.10.1-beta.2`.
- Upgraded preview version of `@canva/app-eslint-plugin` to `1.0.0-beta.10`.
...
- Fixed strict lint violations in the app templates.

## 2026-07-02

### 🔧 Changed

- Upgraded `@canva/app-ui-kit` to `5.12.0`.
...
- Update Jest to match `*.spec` and `*.test` files and add test helpers for rendering components with UI kit providers
...
- Upgraded `@canva/app-ui-kit` to `5.10.0`.
